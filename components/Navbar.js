    ...
    <div className="hidden md:flex md:flex-col w-full h-[60%] fixed top-0 bg-white shadow-xl z-10">
      ...
      <div className="text-center">
        <ul className="text-lg font-medium">
          ...
          <li className="py-4"><a href="#certifications" onClick={() => setIsOpen(false)}>Certifications</a></li>
        ...
        <ul className="flex justify-center py-8 text-xl">
          <li className="text-blue-500 mx-6"><a href="https://github.com/VinayakGS-22" target="_blank" rel="noreferrer"><AiFillGithub /></a></li>
          
          <li className="text-blue-500 mx-6"><a href="https://www.linkedin.com/in/vinayak-gs-7174571b0/" target="_blank" rel="noreferrer"><AiFillLinkedin /></a></li>
    ...
    <div className=" sticky top-0 bg-white shadow-xl z-10">
      ...
      <div className="text-center py-8 px-10 flex justify-between md:hidden">
        <ul className="flex justify-center text-lg font-medium">
          ...
          <li className="px-8"><a href="#certifications">Certifications</a></li>
